                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 col-md-10 offset-md-1">
                                <form method="POST" action="<?php echo base_url(); ?>responsables/insertar" autocomlete="off" class="formulario-personalizado" id="formulario-tabs-parents">
                                    <?= csrf_field() ?>
                                    <!-- Pestañas -->
                                    <ul class="nav nav-tabs" id="registroTabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="tutor-tab" data-toggle="tab" href="#tutor">Datos del tutor (opcional)</a>
                                        </li>
                                    </ul>
                                                ...
                                                <div class="col-12 col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control <?= session('errors.id_nacionalidad') ? 'is-invalid' : '' ?>"
                                                            id="id_nacionalidad_padre" name="responsables[0][id_nacionalidad]">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-3">
                                                    <div class="form-group">
                                                        <label for="id_nacionalidad" class="control-label">Nacionalidad: <small class="obligatorio-formulario">*</small></label>
                                                        <select class="form-control <?= session('errors.id_nacionalidad') ? 'is-invalid' : '' ?>"
                                                            id="id_nacionalidad_madre" name="responsables[1][id_nacionalidad]">
                                                            <option value="">Seleccione una opción</option>
                                                            <?php foreach ($nacionalidades as $nac): ?>
                                                                <option value="<?= esc($nac['id']); ?>"
                                                                    <?= old('id_nacionalidad') == $nac['id'] ? 'selected' : ''; ?>>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-3">
                                                        <div class="form-group">
                                                            <label for="id_nacionalidad" class="control-label">Nacionalidad: <small class="obligatorio-formulario">*</small></label>
                                                            <select class="form-control <?= session('errors.id_nacionalidad') ? 'is-invalid' : '' ?>"
                                                                id="id_nacionalidad_tutor" name="responsables[2][id_nacionalidad]">
                                                                <option value="">Seleccione una opción</option>
                                                                <?php foreach ($nacionalidades as $nac): ?>
                                                                    <option value="<?= esc($nac['id']); ?>"
                                                                        <?= old('id_nacionalidad') == $nac['id'] ? 'selected' : ''; ?>>

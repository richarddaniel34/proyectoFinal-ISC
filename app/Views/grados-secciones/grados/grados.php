...
<main>
  <div class="container-fluid px-4">
    <div class="mb-3">
      ...
      <a href="<?= base_url('grados-y-secciones/grados/grados_inactivos') ?>" class="btn btn-danger">
        <i class="fa-solid fa-plus"></i> Grados Inactivos
      </a>
...
<script>
  document.addEventListener('click', function(e) {
    const boton = e.target.closest('.btn-inactivar'); // delegación
    if (!boton) return;
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location.href = "<?= base_url('grados-y-secciones/grados/inactivar_grado/') ?>" + id;
      }
    });
  });
</script>

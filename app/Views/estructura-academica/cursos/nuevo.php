...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles">
            <i class="fa-solid fa-school"></i> <?= esc($titulo_1) ?> / <small><?= esc($titulo_2) ?> / <?= esc($titulo_3) ?></small>
        </h1>
    </div>
</div>
<br>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 col-md-10 offset-md-1">
                                <form method="POST" action="<?= base_url('estructura-academica/cursos/guardar') ?>" class="formulario-personalizado" autocomplete="off">
                                    ...
                                    <div class="tab-content mt-3">
                                        ...
                                        <div class="tab-pane fade show active" id="datos-basicos">
                                            ...
                                            <div class="text-center mt-5">
                                                <button type="submit" class="btn btn-success text-ligh btn-sistema">
                                                    <i class="fa-solid fa-floppy-disk"></i> <b>GUARDAR</b>
                                                </button>
                                                <a
                                                    href="#"
                                                     onclick="mostrarModalCancelar('<?= base_url('estructura-academica/cursos') ?>')"

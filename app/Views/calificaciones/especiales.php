...
<div class="form-calificaciones-wrapper">
  <form action="<?= base_url('calificaciones/guardarEspecial') ?>" method="POST" class="tabla-calificaciones-form">
    <?= csrf_field() ?>
    ...
    <div class="tabla-calificaciones-container mt-3">
      <table class="tabla-calificaciones table table-striped" id="tabla-especial">
        <thead></thead>
        <tbody></tbody>
      </table>
    </div>
    ...
    <div class="form-calificaciones-footer">
      <button type="submit" class="btn-enviar-calif">Guardar Especial</button>
    </div>
  </form>
</div>
...
<input type="hidden" id="estudiantes-especial-url" value="<?= base_url('calificaciones/estudiantes-especial') ?>">
<input type="hidden" id="tipo_usuario" value="<?= esc($tipo_usuario) ?>">

<?= $this->section('scripts') ?>
<script src="<?= base_url('js/modules/calificaciones/especial.js') ?>"></script>
<?= $this->endSection() ?>
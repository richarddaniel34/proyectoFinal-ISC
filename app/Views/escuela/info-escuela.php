...
<main>
  <div class="container-fluid px-4">
    ...
    <div>
      <p>
        <a href="<?php echo base_url(); ?>/escuela/nuevo" class=" btn btn-primary text-light " id="plus-user"><i class="fa-solid fa-plus"></i>Agregar Escuela</a>
        <a href="<?php echo base_url(); ?>escuela/eliminados" class="btn btn-danger text-light" id="minus-user"><i class="fa-solid fa-minus"></i> Eliminados</a>
      </p>
    </div>
    <div class="">
            ...
            <tbody>
              <?php foreach ($datos as $dato) { ?>
                <tr>
                  ...
                  <td><a href="<?php echo base_url(). "escuela/visualizar/". $dato['id']; ?>" class="text-primary"><i class="fa-solid fa-eye"></i></a></td>
                  <td><a href="<?php echo base_url(). "escuela/editar/". $dato['id']; ?>" class="text-warning"><i class="fa-solid fa-edit"></i></a></td>

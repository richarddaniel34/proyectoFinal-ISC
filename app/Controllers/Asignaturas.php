...
class Asignaturas extends BaseController
{
    ...
    public function nuevo()
    {
        ...
        $data = ['titulo_1' => 'Configuración', 'titulo' => 'Registro de asignaturas', 'tipo_asignaturas' => $tipo_asignaturas];

        //$data = ['titulo' =>'Registro de datos del centro educativo'];

        echo view('header');
        echo view('asignaturas/nuevo', $data);
        echo view('footer');
    }
    ...
    public function insertar()
    {
        ...
        return redirect()->to(base_url() . '/asignaturas')->with('success', 'Datos guardados correctamente.');
    }
    ...
    public function editar($id)
    {
        ...
        if (!$asignatura) {
            return $this->response->setStatusCode(404)->setBody('Asignatura no encontrada.');
        }
        ...
        $data = ['titulo' => 'Editar Asignatura', 'datos' => $asignatura, 'tipo_asignaturas' => $tipo_asignaturas];
    ...
    public function actualizar($id) {
        ...
        return redirect()->to(base_url() . '/asignaturas')->with('success', 'Datos actualizados correctamente.');
    }
